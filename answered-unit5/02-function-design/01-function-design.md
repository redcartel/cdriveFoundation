...
* A function that takes a list as an argument and prints out the contents of each element on a numbered line, like:
...
* A function that takes a string as an argument and returns a list of two character segments of the string. If there are an odd number of characters in the input string, the final element in the list should be a single character. Like:
...
* Challenge: A function that takes two integers, one that represents a width and one that represents a height, and returns a new two dimensional array, where each element is None
