...
* A function that takes a string as input and returns a list of two character segments of the string. If there are an odd number of characters in the input string, the final element in the list should be a single character. Like:
